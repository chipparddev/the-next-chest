...
explicit_modifier_function_finder = {
    ...
    'flat-damage' : lambda variant : (lambda knowledge : ceil(knowledge * (knowledge + 1) / {'weapon' : 2, 'gem' : 4}[variant])),
    'melee-flat-damage' : lambda knowledge : ceil(knowledge * (knowledge + 1) / 3),
    'ranged-flat-damage' : lambda knowledge : ceil(knowledge * (knowledge + 1) / 3),
    'melee-light-flat-damage' : lambda knowledge : ceil(knowledge * (knowledge + 1) / 2.4),
    'melee-medium-flat-damage' : lambda knowledge : ceil(knowledge * (knowledge + 1) / 2.4),
    'melee-heavy-flat-damage' : lambda knowledge : ceil(knowledge * (knowledge + 1) / 2.4),
    'ranged-light-flat-damage' : lambda knowledge : ceil(knowledge * (knowledge + 1) / 2.4),
    'ranged-medium-flat-damage' : lambda knowledge : ceil(knowledge * (knowledge + 1) / 2.4),
    'ranged-heavy-flat-damage' : lambda knowledge : ceil(knowledge * (knowledge + 1) / 2.4),
